...
import { AccessControllerInputButton } from './custom-inputs/access-controller-input/AccessControllerInput';
...
const FormFields = ({ formField, form, ...others }: Props) => {
  ...
  switch (formType) {
    ...
    case 'access-controller':
      return <AccessControllerInputButton form={form} formField={formField} {...others} />;
    case 'custom':
