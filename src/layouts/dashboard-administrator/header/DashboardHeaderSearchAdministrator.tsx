...
import classesM from './DashboardHeaderSearchAdministrator.module.css';
import { HeaderNotificationButton } from './notifications/HeaderNotificationButton';
import { ADMIN_DASHBOARD_TABLIST } from '../../../sections/administrator/dashboard/AdminDashBoardTabList';

export type JSONType = typeof links;

export function DashboardHeaderSearchAdministrator() {
  ...
  return (
    <header className={classesM.header}>
      ...
      <TabList list={ADMIN_DASHBOARD_TABLIST} />
      {isMobile && (
